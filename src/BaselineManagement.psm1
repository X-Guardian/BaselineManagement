...
function ConvertFrom-GPO
{
    ...
    (
        ...
        # This determines whether to skip producing the MOF file
        [switch]$SkipMofFile,

        # Name of the Configuration
        [string]$ConfigName = 'DscFromGpo',

        # This determines whether to skip adding the Invoke Configuration command
        [switch]$SkipInvokeConfiguration
        )
    ...
    end
    {
        ...
        # If the switch wasn't specified, create the MOF File if possible
        if (-not $SkipMofFile)
        {
